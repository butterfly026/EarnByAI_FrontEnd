...
export default () => {
  ...
  const { lang } = useMyIntl("Usingandmanagingsecuritykeys");
  return (
      ...
      <Flex w="100%" flexDir="column" margin="0 auto" px={5}>
        ...
        <Flex pt={10} flexWrap="wrap">
          ...
          >
            ...
            <Flex w="full">
              <Image src="https://images.ctfassets.net/7ca8qfn907uv/1HjA8aejYkX85AgOEauisT/e3ae3e19a6bf96b1a4632299299c84d9/using-and-managing-security-keys.png" />
            </Flex>
            <Text
              fontWeight="var(--cds-fontWeights-medium)"
              pt={12}
