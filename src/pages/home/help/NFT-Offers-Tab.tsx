...
export default () => {
  ...
  const { lang } = useMyIntl("NFTOffersTab");
  return (
      ...
      <Flex w="100%" flexDir="column" margin="0 auto" px={5}>
        ...
        <Flex pt={10} flexWrap="wrap">
          ...
          >
            ...
            <Flex w="full">
              <Image src="https://images.ctfassets.net/7ca8qfn907uv/1sSH0kIDUY1DsVa9b4En17/83db3d549008368aca87efed5a01f8df/nft_offers_tab.png" />
            </Flex>
