...
import { Breadcrumb, BreadcrumbItem, BreadcrumbLink, Flex, Input, Link, Text } from '@chakra-ui/react';
...
export default () => {
  ...
  const { lang } = useMyIntl("PaymentmethodsforUKcustomers");
  return (
