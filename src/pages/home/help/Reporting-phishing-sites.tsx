...
export default () => {
  ...
  const { lang } = useMyIntl("Reportingphishingsites");
  return (
        ...
        <Flex pt={10} flexWrap="wrap">
          ...
          >
            ...
            <Text fontSize="1rem" pt={6}>
              ...
              <Link
                color="#1652f0"
                href="https://mxtoolbox.com/public/content/emailheaders/"
              >
                https://mxtoolbox.com/public/content/emailheaders/
              </Link>
              {lang[11]}
            </Text>
            <Text as="i">{lang[12]}</Text>
            <Text
              fontWeight="var(--cds-fontWeights-medium)"
              pt={12}
              pb={4}
            ...
            <Text fontSize="1rem" pt={6}>
              {lang[14]}
              <Link color="#1652f0" href="security@coinbase.com">
                security@coinbase.com
              </Link>
              {lang[15]}
            </Text>
