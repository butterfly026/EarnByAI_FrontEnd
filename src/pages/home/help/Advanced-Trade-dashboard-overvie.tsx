...
export default () => {
  const { lang } = useMyIntl("AdvancedTradedashboardoverview");
  return (
      ...
      <Flex w="100%" flexDir="column" margin="0 auto" px={5}>
        ...
        <Flex pt={10} flexWrap="wrap">
          ...
          >
            ...
            <Flex w="full">
              <Image src="https://images.ctfassets.net/7ca8qfn907uv/3NFkn4Qo35vMZSF3no0d69/2adea3e1318023e1b50b50690e53884d/Advanced_Trade_Navigation_Consumer_advanced_trade_overview.gif" />
            </Flex>
            <Text
              as="ul"
              listStyleType="disc"
            ...
            <Flex w="full">
              <Image src="https://images.ctfassets.net/7ca8qfn907uv/3aZDAijsDHq2j6mNKVC3xV/baa065ec4c7d922491056710ab09ce35/Price_Chart_Consumer_advanced_trade_view.gif" />
            </Flex>
            <Text
              fontWeight="var(--cds-fontWeights-medium)"
              pt={12}
