...
export default () => {
  ...
  const { lang } = useMyIntl("WhatisAutomaticstaking");
  return (
          ...
          <Flex pt={10} flexWrap="wrap">
            <Flex flexDir="column" flex="1" sx={{padding: {base: "0 0.2rem", sm: "0 0.2rem", md: "0 2rem 0 0", lg: "0 2rem 0 0",},}}>
              ...
              <Text as="ul" listStyleType="disc" fontSize="1rem" pt={6} pl={6} pb="4" ><Text as="li" display="list-item">
                ...
                <Text as="ul" listStyleType="square" fontSize="1rem" pt={6} pl={6} pb="4" ><Text as="li" display="list-item">
                  {lang[9]}
                </Text>
                  <Text as="li" display="list-item"><Text as="li" display="list-item">
                    {lang[10]}
                  </Text></Text></Text></Text>
              <Text as="ul" listStyleType="disc" fontSize="1rem" pt={6} pl={6} pb="4" ><Text as="li" display="list-item">
                {lang[11]}
