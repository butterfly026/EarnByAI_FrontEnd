...
export default () => {
  ...
  const { lang } = useMyIntl("Bridgingyourcrypto");
  return (
                  ...
                  {({ isExpanded }) => (
                    <>
                      ...
                      <AccordionPanel pb={4}>
                        ...
                        <Text fontSize="1rem" pt={6}>
                          <Flex w="full">
                            <Image src="https://images.ctfassets.net/7ca8qfn907uv/4ndnB21YDGkgfeV1If6nXO/9e1c2bd3ff7da0e71a970abb2c72f6bf/Wallet_Bridging_Demo_.gif" />
                          </Flex>
                        </Text>
                      </AccordionPanel>{" "}
                    </>
