...
export default () => {
  ...
  const { lang } = useMyIntl("UsingCoinbasePay");
  return (
        ...
        <Flex pt={10} flexWrap="wrap">
          ...
          >
            ...
            <Alert
              ...
              bg="#0885501a"
              py={6}
              sx={{ borderRadius: "10px", border: "1px solid #088550" }}
            >
              <Flex>
                {" "}
                <Image boxSize="var(--cds-sizes-6)" src={Right} />
                <Text pl={3}>
                  <Text
                    fontWeight="var(--cds-fontWeights-medium)"
                    fontSize="1.25rem"
                    ...
                    <>
                      ...
                      <AccordionPanel pb={4}>
                        ...
                        >
                          ...
                          <Flex w="full">
                            <Image src="https://images.ctfassets.net/7ca8qfn907uv/6dVUtFIEa8MuDEVRpEAhOc/df3762e7ffbb549e38a7f476c5ac239a/unnamed__12_.png" />
                          </Flex>
                          <Text as="li" display="list-item">
                            {lang[91]}
                          </Text>
                          <Flex w="full">
                            <Image src="https://images.ctfassets.net/7ca8qfn907uv/67My6fIguFaaLJhUuODRLj/e68b5cc33e210db11f13439710c53cd1/unnamed__13_.png" />
                          </Flex>
                          <Text as="li" display="list-item">
                            {lang[92]}
                          </Text>
                          <Flex w="full">
                            <Image src="https://images.ctfassets.net/7ca8qfn907uv/7Anno8k8Ispb6eyQi2wYnK/8ed5805feeb9fcc8c82d4ff08dc5a3b2/unnamed__15_.png" />
                          </Flex>
                          <Text as="li" display="list-item">
                            {lang[93]}
                          </Text>
                          ...
                          <Flex w="full">
                            <Image src="https://images.ctfassets.net/7ca8qfn907uv/4Ei7ynUIuEwceo0clrETy3/49190b1a2a35a44ff8d33f86bce05dc0/unnamed__16_.png" />
                          </Flex>
                          <Text as="li" display="list-item">
                            {lang[96]}
                          </Text>
