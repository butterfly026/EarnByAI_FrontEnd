...
export default () => {
  ...
  const { lang } = useMyIntl("HowdoIverifymyidentity");
  const RListC = [
    {
      label: lang[4],
      href: "#iOS-and-Android",
    },
    {
      label: lang[16],
      href: "#Verify-your-phone-number-on-the-mobile-app",
    },
  ];
  return (
        ...
        <Flex pt={10} flexWrap="wrap">
          ...
          >
            ...
            <Text
              ...
              letterSpacing="-0.08rem"
              id="Verify-your-phone-number-on-the-mobile-app"
            >
              {lang[16]}
            </Text>
            <Text
