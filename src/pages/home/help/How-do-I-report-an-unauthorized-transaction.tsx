...
export default () => {
  ...
  const { lang } = useMyIntl("HowdoIreportanunauthorizedtransaction");
  return (
        ...
        <Flex pt={10} flexWrap="wrap">
          ...
          >
            ...
            >
              ...
              <Flex w="full">
                <Image src="https://images.ctfassets.net/7ca8qfn907uv/3NEVo57AgVrE9KbtiWgQNo/87efcbadb8dc0d99aeda2967af7a96da/How_do_I_report_an_unauthorized_transaction.png" />
              </Flex>
              <Text as="li" display="list-item">
                {lang[10]}
              </Text>
