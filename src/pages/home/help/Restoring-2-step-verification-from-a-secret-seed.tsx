...
export default () => {
  ...
  const { lang } = useMyIntl("Restoring2stepverificationfromasecretseed");
  const RListC = [
    {
      label: lang[9],
      ...
      <Flex w="100%" flexDir="column" margin="0 auto" px={5}>
        ...
        <Flex pt={10} flexWrap="wrap">
          ...
          >
            ...
            <Flex w="full">
              <Image src="https://images.ctfassets.net/7ca8qfn907uv/3XNrHwch3ppfstFP0HraHP/891c9d7a1ee90d38ceb21418b70a45e8/Article-Inline-783689.png" />
            </Flex>
            <Text
              fontWeight="var(--cds-fontWeights-medium)"
              pt={12}
