...
export default () => {
  ...
  const { lang } = useMyIntl("WhatistheExperimentalassetlabel");
  return (
      ...
      <Flex w="100%" flexDir="column" margin="0 auto" px={5}>
        ...
        <Flex pt={10} flexWrap="wrap">
          ...
          >
            ...
            <Flex w="full">
              <Image src="https://images.ctfassets.net/7ca8qfn907uv/5Y51B2RPQbZeTnnSk7hKDU/1aabdd431a790f705e266bc9e8403a56/Experimental_assets_consumer_experimental_label.gif" />
            </Flex>
            <Text fontSize="1rem" pt={6}>
              {lang[17]}
            </Text>
