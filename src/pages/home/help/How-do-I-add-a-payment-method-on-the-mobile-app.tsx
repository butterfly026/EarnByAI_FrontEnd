...
export default () => {
  ...
  const { lang } = useMyIntl("HowdoIaddapaymentmethodonthemobileapp");
  return (
          ...
          >
            ...
            <Flex w="full" py={5}>
              <video
                controls
                width="100%"
                src="/img/mov/How to add a payment method on the Coinbase app.mp4"
              ></video>
            </Flex>
            <Text
              fontWeight="var(--cds-fontWeights-medium)"
