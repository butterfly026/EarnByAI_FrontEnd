...
export default () => {
  ...
  const { lang } = useMyIntl("Managingmycreditaccount");
  return (
        ...
        <Flex pt={10} flexWrap="wrap">
          ...
          >
            ...
            >
              ...
              <Text as="li" display="list-item">
                {lang[17]}
                <Text as="b">{lang[18]}</Text> to see more information and make
                a payment
              </Text>
            </Text>
            <Text
            ...
            <Text mt={6} p={6} background="#9a9a9a17">
              <Text>
                <Text
                  fontSize="1rem"
                  fontWeight="var(--cds-fontWeights-medium)"
            ...
            <Text fontSize="1rem" pt={6}>
              {lang[43]}
              <Link color="#1652f0" href="https://www.coinbase.com/borrow">
