...
export default () => {
  ...
  const { lang } = useMyIntl("Howtoaccessprivacysettingsandmakerequests");
  return (
      ...
      <Flex w="100%" flexDir="column" margin="0 auto" px={5}>
        ...
        <Flex pt={10} flexWrap="wrap">
          ...
          >
            ...
            <Flex w="full">
              <Image src="https://images.ctfassets.net/7ca8qfn907uv/21ZoClZYzcZmI7NccNRYU0/e9aa70655bb25ab901c7fc8bc67c6f16/Screen_Shot_2020-02-28_at_2.17.57_PM.png" />
            </Flex>
          </Flex>
          <Flex
