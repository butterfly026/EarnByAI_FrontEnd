...
export default () => {
  ...
  const { lang } = useMyIntl("WhattypeofsecuritydoesAiTradeprovide");
  return (
        ...
        <Flex w="100%" flexDir="column" margin="0 auto" px={5}>
          ...
          <Flex pt={10} flexWrap="wrap">
            <Flex flexDir="column" flex="1" sx={{padding: {base: "0 0.2rem", sm: "0 0.2rem", md: "0 2rem 0 0", lg: "0 2rem 0 0",},}}>
              ...
              <Flex mt={10} pt={6}><Alert status="warning" variant="subtle" bg="#f4c62117" py={6} sx={{ borderRadius: "10px", border: "1px solid #f4c622" }} ><Flex><AlertIcon w="var(--cds-sizes-6)" color="#f4c622" /> <AlertDescription>
                {lang[4]}
              </AlertDescription></Flex> </Alert> </Flex>

              <Text fontSize="1rem" pt={6} >
                {lang[5]}
              </Text>

              <Text as="ul" listStyleType="disc" fontSize="1rem" pt={6} pl={6} pb="4" ><Text as="li" display="list-item">
                {lang[6]}
              </Text>

                <Text as="li" display="list-item">
                  {lang[7]}
                  <Link color="#1652f0" href="https://etherscan.io/">
                    {lang[8]}
                  </Link>.</Text>
