...
export default () => {
  ...
  const { lang } = useMyIntl("Passwordsecuritymeasures");
  return (
      ...
      <Flex w="100%" flexDir="column" margin="0 auto" px={5}>
        ...
        <Flex pt={10} flexWrap="wrap">
          ...
          >
            ...
            <Flex w="full">
              <Image src="https://images.ctfassets.net/7ca8qfn907uv/4Lb6r6wrV6L6dmVKivjgcp/6ab837f494ce5818dab5a08f037339af/bcrypt_coinbase_password_security_measures.png" />
            </Flex>
            <Text
              fontWeight="var(--cds-fontWeights-medium)"
              pt={12}
