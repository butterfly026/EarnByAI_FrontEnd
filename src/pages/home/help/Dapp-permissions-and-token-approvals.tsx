...
export default () => {
  ...
  const { lang } = useMyIntl("Dapppermissionsandtokenapprovals");
  return (
      ...
      <Flex w="100%" flexDir="column" margin="0 auto" px={5}>
        ...
        <Flex pt={10} flexWrap="wrap">
          ...
          >
            ...
            <Flex w="full">
              <Image src="https://images.ctfassets.net/7ca8qfn907uv/6YiozWIrjBLRuqjXvvcjk4/1e6e0bcfc322db54d2ce671df3be3682/dapp-permissions.png" />
            </Flex>
            <Text fontSize="1rem" pt={6}>
