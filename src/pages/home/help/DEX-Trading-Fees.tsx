...
export default () => {
  ...
  const { lang } = useMyIntl("DEXTradingFees");
  return (
                  ...
                  {({ isExpanded }) => (
                    <>
                      ...
                      <AccordionPanel pb={4}>
                        ...
                        <Text fontSize="1rem" pt={6}>
                          <Flex w="full">
                            <Image src="https://images.ctfassets.net/7ca8qfn907uv/3qSAh1Pam5f1lvRkER4CmW/34a0e5fab4ebda61514d39f13569f2b7/trade_with_a_dex_-_locate_fee_for_transaction.png" />
                          </Flex>
                        </Text>
                      </AccordionPanel>{" "}
                    </>
