...
export default () => {
  ...
  const { lang } = useMyIntl(
    "WhydidIreceiveanunexpecteddeviceconfirmationemail"
  );
  return (
          ...
          >
            ...
            <Text fontSize="1rem" pt={6}>
              ...
              <Link color="#1652f0" href="#">
                https://www.coinbase.com/settings/account
              </Link>
            </Text>
            <Text fontSize="1rem" pt={6}>
              {lang[10]}
            ...
            <Flex w="full">
              <Image src="https://images.ctfassets.net/7ca8qfn907uv/7D7QhTYcr1LmenzgLj6A5j/b1ff770a7809ffb5637cb00aa5c83b48/Screen_Shot_2019-03-05_at_1.10.38_PM.png" />
            </Flex>
            <Text fontSize="1rem" pt={6}>
              {lang[11]}
